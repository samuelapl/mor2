...
export const COMMON_TRANSLATIONS: Record<string, TranslationEntry> = {
  ...
  noRecentAudit: { en: "No recent audit activity recorded.", am: "ምንም የቅርብ ጊዜ የኦዲት እንቅስቃሴ አልተመዘገበም።" },
  ...
  curriculumPendingApproval: { en: "Curriculum Pending Your Approval", am: "ማጽደቅዎን የሚጠብቁ ስርዓተ-ትምህርቶች" },
