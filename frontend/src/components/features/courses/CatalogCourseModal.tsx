...
export function CatalogCourseModal({
        ...
        if (!cancelled) {
          ...
          if (inPerson.length > 0) {
            const firstAvailable = inPerson.find((s) => {
              ...
              const booked = bookedSeatCount(s);
              return cap - booked > 0;
            });
            if (firstAvailable) {
  ...
  const isSeatFull =
    ...
    (() => {
      ...
      const booked = bookedSeatCount(chosen);
      return cap - booked <= 0;
    })();
                ...
                {loadingSessions ? (
                  ...
                  <div className="grid gap-2.5 sm:grid-cols-2">
                    {availableSessions.map((session) => {
                      ...
                      const booked = bookedSeatCount(session);
            ...
            <div>
              ...
              <div className="font-semibold text-slate-800">
                <RichContent
                  ...
                  placeholder="All Staff & Officers"
                />
              </div>
            </div>
            <div>
        ...
        description={
          <div className="space-y-2">
            ...
            <p className="text-xs text-slate-500">
              You will be taken to the course once enrollment is complete.
            </p>
          </div>
        }
      />
