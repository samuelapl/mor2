            ...
            {totalItems !== undefined && rangeEnd !== null ? (
              isAmharic ? (
                <span>
                  ...
                  <strong className="font-semibold text-slate-800">{rangeStart} - {rangeEnd}</strong> በማሳየት ላይ
                </span>
              ) : (
                <span>
                  Showing <strong className="font-semibold text-slate-800">{rangeStart} - {rangeEnd}</strong> of{" "}
                  <strong className="font-semibold text-slate-800">{totalItems}</strong> results
                </span>
              )
            ) : (
              <span>
