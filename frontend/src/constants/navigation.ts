...
export const NAV_ITEMS: Record<Role, NavItem[]> = {
  course_owner: [
    ...
    { label: "Create Course", href: "/course-owner/create-course", icon: FilePlus2, permission: "course.create" },
  ...
  training_admin: [
    ...
    { label: "Publish Courses", href: "/training-admin/publish", icon: Send, permission: "course.publish" },
