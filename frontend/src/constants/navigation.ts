...
export const NAV_ITEMS: Record<Role, NavItem[]> = {
  course_owner: [
    ...
    },
    {
      ...
      icon: FileQuestion,
      permission: ["quiz.create", "quiz.grade"],
    },
  ],
  content_approver: [
    { label: "Dashboard", href: "/content-approver", icon: LayoutDashboard },
    {
      ...
      href: "/courses",
      icon: BookOpen,
      permission: ["course.view.all", "course.approve", "course.reject"],
    },
    {
...
export const PERMISSION_GATED_PATHS: Record<string, string[]> = {
  ...
  "/courses": ["course.view.own", "course.view.all", "course.view.assigned", "course.create", "course.browse"],
  "/course-owner/create-course": ["course.create"],
  "/course-owner/question-bank": ["quiz.create", "quiz.grade"],
  ...
  "/trainer/question-bank": ["quiz.create", "quiz.grade"],
  "/trainer/create-quiz": ["quiz.create"],
  "/content-approver/pending-approvals": ["course.approve", "course.reject"],
  "/content-approver/approved-courses": ["course.approve", "course.reject", "course.view.all"],
  ...
  "/system-admin/pending-course-approvals": ["course.approve", "course.reject"],
