  ...
  return (
    <>
      <PageShell
        ...
        description={tBilingual("Choose how you'd like to build this course.", "ይህንን ኮርስ እንዴት መገንባት እንደሚፈልጉ ይምረጡ።")}
      >
        <div className="grid w-full gap-4 sm:grid-cols-2">
          {[
            ...
            },
            {
              ...
              description: tBilingual("Import a ready-made SCORM package as a course.", "የተዘጋጀ የ SCORM ጥቅል እንደ ኮርስ ያስመጡ።"),
            },
          ].map((option) => (
            <button
              key={option.key}
      ...
      <WorkspaceDetailOverlay
        ...
        subtitle={tBilingual("Import a ready-made SCORM package as a course.", "የተዘጋጀ የ SCORM ጥቅል እንደ ኮርስ ያስመጡ።")}
      >
