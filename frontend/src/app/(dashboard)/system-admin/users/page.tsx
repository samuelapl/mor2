...
export default function UsersPage() {
  ...
  const withClearedSelection = (setter: (value: string) => void) => (value: string) => {
    setter(value);
  ...
  return (
    <PageShell
      ...
      description={tBilingual(
        'Manage user accounts, approval status, and role assignments.',
        'የተጠቃሚ መለያዎችን፣ የማረጋገጫ ሁኔታን እና የሚና ምደባዎችን ያስተዳድሩ።',
      )}
                  ...
                  <Td>
                    <div className="flex flex-wrap items-center gap-1.5">
                      ...
                      {user.mustChangePassword ? (
                        <Badge variant="amber">
                          {tBilingual('Must change password', 'የይለፍ ቃል መቀየር አለበት')}
                        </Badge>
                      ) : null}
                    </div>
                  </Td>
      ...
      >
        {bulkAction === 'suspend' ? (
          ...
          <p className="text-sm text-slate-600">
            ...
            sign in. Their course history, certificates and audit records are kept, and their emails
