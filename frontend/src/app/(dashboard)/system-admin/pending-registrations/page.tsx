...
export default function PendingRegistrationsPage() {
  ...
  const { page, totalPages, setPage, pageItems, pageSize, setPageSize, totalItems } = usePagination(pending, 10);
    ...
    >
      ...
      {pending.length === 0 ? (
        <EmptyState
          ...
          description={tBilingual("All registration requests have been reviewed.", "ሁሉም የምዝገባ ጥያቄዎች ተገምግመዋል።")}
        />
      ) : (
        <>
          <Table
