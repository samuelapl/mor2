    ...
    <div className="relative mx-auto w-full max-w-3xl">
      ...
      <div className="relative overflow-hidden rounded-2xl border border-white/15 bg-slate-900/80 shadow-2xl shadow-slate-400/30 backdrop-blur-xl">
        ...
        <div className="grid gap-3 p-5 sm:grid-cols-4">
          {[
            {
              label: tBilingual('Courses', 'ኮርሶች'),
              value: stats ? String(stats.courses) : '—',
              icon: BookOpen,
            },
            {
              label: tBilingual('Staff', 'ሰራተኞች'),
              value: stats ? String(stats.staff) : '—',
              icon: UsersRound,
            },
            {
              label: tBilingual('Sessions', 'ክፍለ-ጊዜዎች'),
              value: stats ? String(stats.sessions) : '—',
              icon: CalendarRange,
            },
            {
              label: tBilingual('Certificates', 'ሰርተፍኬቶች'),
              value: stats ? String(stats.certificates) : '—',
              icon: Layers,
            },
          ].map((stat) => (
        ...
        <div className="space-y-3 px-5 pb-5">
          {[
            {
              title: tBilingual('Customs Modernization', 'የጉምሩክ ዘመናዊ አሰራር'),
              pct: 82,
              color: 'from-indigo-500 to-violet-500',
            },
            {
              title: tBilingual('Taxpayer Service Excellence', 'የላቀ የግብር ከፋዮች አገልግሎት'),
              pct: 64,
              color: 'from-indigo-500 to-violet-500',
            },
            {
              title: tBilingual('Advance Pricing Agreements', 'የቅድመ ዋጋ ስምምነቶች (APA)'),
              pct: 100,
...
export default function LandingPage() {
  ...
  const rolesBrief = [
    ...
    },
    {
      ...
      description: tBilingual('Delivers live sessions and quizzes.', 'የቀጥታ ስብሰባዎችንና ፈተናዎችን ይመራል።'),
      icon: Presentation,
  ...
  const faqs = [
    ...
    {
      question: tBilingual('How do I sign in?', 'እንዴት መግባት እችላለሁ?'),
      answer: tBilingual(
    ...
    {
      question: tBilingual('Which account should I try first?', 'መጀመሪያ የትኛውን አካውንት ልሞክር?'),
      answer: tBilingual(
    ...
    {
      question: tBilingual('Can I switch between languages?', 'ቋንቋዎችን መቀያየር እችላለሁ?'),
      answer: tBilingual(
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="mx-auto mt-10 flex max-w-lg flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs text-slate-500">
            <span className="inline-flex items-center gap-1.5">
              ...
              {stats
                ? tBilingual(
                    `${stats.courses} courses in the catalog`,
                    `${stats.courses} ኮርሶች በካታሎግ ውስጥ`,
                  )
          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-3 font-display text-2xl font-bold tracking-tight text-slate-900 sm:text-3xl">
              {tBilingual(
                ...
                'ከኮርስ ሀሳብ እስከ ሰርተፍኬት በአራት ደረጃዎች',
              )}
            </h2>
            <p className="mt-3 text-sm leading-relaxed text-slate-500">
              {tBilingual(
            ...
            <div className="relative">
              ...
              <p className="mt-5 text-[11px] text-slate-500">
                {tBilingual(
                  ...
                  'ሁሉም የሙከራ አካውንቶች “password” የሚለውን የይለፍ ቃል ይጠቀማሉ።',
                )}
              </p>
            </div>
          </div>
      ...
      <footer className="relative border-t border-slate-200 px-6 py-10">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-6 sm:flex-row">
          ...
          <p className="text-[11px] text-slate-400">
            ...
            {tBilingual('MoR Learning Management System', 'የገቢዎች ሚኒስቴር የስልጠና ማስተዳደሪያ ስርዓት')}
          </p>
        </div>
      </footer>
    </main>
